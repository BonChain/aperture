...
- `packages/sdk/test/adapterVersion.test.ts` — first run failed: `REPO_ROOT` computed from `import.meta.url` had 5 `..` segments (resolved to `/mnt/`), needed 3 (`/mnt/d/work/aperture/`). Fixed path math.
